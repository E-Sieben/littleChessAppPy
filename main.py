...
print("----------------------------------------------")
print(
    f"♚  White won {(white_wins/total_games)*100}% of Games, that's {white_wins} times")
print(
    f"♔  Black won {(black_wins/total_games)*100}% of Games, that's {black_wins} times")
print(f"⚔️  Game tied {(ties/total_games)*100}% of Games, that's {ties} times")
print("-----------------------------------------------")
